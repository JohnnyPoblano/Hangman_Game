...
public class Medium_Game{
  //For Medium game mode: Words between 5 and 7 letters long. 
...
//__Constants________________________________________________________________________________________
  //Scoring Constants
  final static int WON = 50;
  final static int LOST = 15;
  final static int LESS_THAN_6 = 50;
  final static int LESS_THAN_7 = 25;
  ...
  //Guessing Constants
  final static int NUMBER_OF_GUESSES = 9;
  final static int GUESSES_MINUS_1 = 8;
  final static int GUESSES_MINUS_2 = 7;
  final static int GUESSES_MINUS_3 = 6;
  final static int GUESSES_MINUS_4 = 5;
  final static int GUESSES_MINUS_5 = 4;
  final static int GUESSES_MINUS_6 = 3;
  final static int GUESSES_MINUS_7 = 2;
  final static int GUESSES_MINUS_8 = 1;
  ...
  final static String GAME_TYPE = "Medium Game";
...
//__UPDATING DISPLAYS________________________________________________________________________________
  private void updateHangman(){
    ...
    if(!correctGuess){
      ...
      if(guessChances == GUESSES_MINUS_7){
      ...
      if(guessChances == GUESSES_MINUS_8){
